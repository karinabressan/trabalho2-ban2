            ...
            try {
                switch (op) {
                    ...
                    case 3: // Genero
                        op = menu2();
                            switch (op){
                                case 1: new GeneroController().createGenero(con); //incluir 
                                       break;
                                case 2: new GeneroController().updateGenero(con);// alterar 
                                        break;
                                case 3: new GeneroController().listarGenero(con);// visualizar
                                        break;
                                case 4: new GeneroController().deleteGenero(con);// deletar
                                        break; 
                            }
                            break;                          
                    case 4: // Cliente
